...
<?php 
   ...
   $selSection = $conn->query("SELECT sec_name as sectionName FROM section_tbl WHERE sec_id='$sectionId' ")->fetch(PDO::FETCH_ASSOC);
 ?>
                           ...
                           <form method="post" id="updateExamFrm">
                               <div class="form-group">
                                ...
                                <select class="form-control" name="sectionId" required="">
                                  <option value="<?php echo $selExamRow['sec_id']; ?>"><?php echo $selSection['sectionName']; ?></option>
                                  <?php 
                                    $selAllSection = $conn->query("SELECT * FROM section_tbl ORDER BY sec_id DESC");
                                    while ($selAllSectionRow = $selAllSection->fetch(PDO::FETCH_ASSOC)) { ?>
                                      <option value="<?php echo $selAllSectionRow['sec_id']; ?>"><?php echo $selAllSectionRow['sec_name']; ?></option>
                                    <?php }
                                   ?>
                                </select>
                              </div>
                               ...
                               {  ?>
                                 <div class="table-responsive">
                                    <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                                        <thead>
                                        <tr>
                                            <th class="text-left pl-1">Section Name</th>
