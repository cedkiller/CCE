...
<div class="modal fade" id="modalForAddSection" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
   <form class="refreshFrm" id="addSectionFrm" method="post">
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <div class="form-group">
            <label>Section</label>
            <input type="text" name="section_name" id="section_name" class="form-control" placeholder="Input Section" required autocomplete="off">
          </div>
        </div>
      </div>
...
<div class="modal fade myModal" id="updateSection-<?php echo $selSectionRow['sec_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog " role="document">
     <form class="refreshFrm" id="addSectionFrm" method="post" >
       <div class="modal-content myModal-content" >
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Update ( <?php echo $selSectionRow['sec_name']; ?> )</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <div class="col-md-12">
            <div class="form-group">
              <label>Section</label>
              <input type="" name="section_name" id="section_name" class="form-control" value="<?php echo $selSectionRow['sec_name']; ?>">
            </div>
          </div>
        </div>
        <div class="modal-footer">
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <select class="form-control" name="sectionSelected">
              <option value="0">Select Section</option>
              <?php 
                $selSection = $conn->query("SELECT * FROM section_tbl ORDER BY sec_id DESC");
      ...
      <div class="modal-body">
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <input type="text" name="bdate" id="bdate" class="form-control" placeholder="Input Student Number" autocomplete="off" >
          </div>
          <div class="form-group">
            <label>Gender</label>
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="section" id="section">
              <option value="0">Select section</option>
              <?php 
                $selSection = $conn->query("SELECT * FROM section_tbl ORDER BY sec_id asc");
                while ($selSectionRow = $selSection->fetch(PDO::FETCH_ASSOC)) { ?>
                  <option value="<?php echo $selSectionRow['sec_id']; ?>"><?php echo $selSectionRow['sec_name']; ?></option>
                <?php }
               ?>
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <input type="" name="question" id="section_name" class="form-control" placeholder="Input question" autocomplete="off">
          </div>
